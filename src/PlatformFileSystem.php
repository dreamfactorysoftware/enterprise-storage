 ...
 *
 * The default functionality (PlatformFileSystem::$partitioned is set to TRUE) of this resolver is to provide partitioned
 ...
 */
class PlatformFileSystem extends EnterprisePaths implements PlatformStorageResolverLike
{
    //*************************************************************************
    //* Constants
    //*************************************************************************
