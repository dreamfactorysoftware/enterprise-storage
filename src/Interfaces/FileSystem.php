...
/**
 * Overrides the Symfony2 Filesystem class accessing the
 *
...
class Filesystem
{
    ...
    public function copy( $originFile, $targetFile, $override = false )
    {
        ...
        if ( $doCopy )
        {
            ...
            {
                throw new IOException(
                    sprintf( 'Failed to copy "%s" to "%s" because target file could not be opened for writing.', $originFile, $targetFile ),
                    0,
                    null,
                    $originFile
                );
            ...
            {
                throw new IOException(
                    sprintf( 'Failed to copy the whole content of "%s" to "%s %g bytes copied".', $originFile, $targetFile, $bytesCopied ),
                    0,
                    null,
                    $originFile
                );
    ...
    public function symlink( $originDir, $targetDir, $copyOnWindows = false )
    {
        ...
        if ( !$ok )
        {
            ...
            {
                throw new IOException(
                    sprintf( 'Symbolic link "%s" is created but appears to be broken.', $targetDir ), 0, null, $targetDir
                );
            }
        }
    }
    ...
    public function mirror( $originDir, $targetDir, \Traversable $iterator = null, $options = array() )
    {
        ...
        {
            $flags =
                $copyOnWindows ? \FilesystemIterator::SKIP_DOTS | \FilesystemIterator::FOLLOW_SYMLINKS : \FilesystemIterator::SKIP_DOTS;
            $iterator =
                new \RecursiveIteratorIterator(
